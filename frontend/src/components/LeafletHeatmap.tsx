...
const MapControls: React.FC<{
  ...
  return (
    <>
      {/* コントロールパネル */}
      <div className="absolute top-4 left-4 bg-white rounded-lg p-4 shadow-lg z-[1000]">
        <div className="text-sm font-semibold mb-3">OpenStreetMap ヒートマップ</div>
        
        <div className="space-y-3">
          <div className="text-xs text-gray-600">
            データポイント: <span className="font-medium">{dataCount}個</span>
          </div>
          
          <div className="text-xs text-gray-600">
            ズーム: <span className="font-medium">{currentZoom.toFixed(1)}</span>
          </div>

          <div className="text-xs text-gray-600">
            中心: <span className="font-mono">{currentCenter.lat.toFixed(4)}, {currentCenter.lng.toFixed(4)}</span>
          </div>
      ...
      {/* 凡例 */}
      <div className="absolute bottom-4 right-4 bg-white rounded-lg p-3 shadow-lg z-[1000]">
